from space_battle.adapters import AutoGenerateAdapter
from space_battle.movement import NewMovingObject
...
def _get_type_of_move_adapter(interface, universal_obj):
    adapter_dict = {
        NewMovingObject: AutoGenerateAdapter,
    }
